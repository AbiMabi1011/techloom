  ...
  return (
    <header className="sticky top-0 z-30 bg-[#0B0F17]/90 backdrop-blur-xl border-b border-white/10 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between gap-3 sm:gap-6">
        ...
        >
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-amber-400 via-amber-500 to-amber-600 flex items-center justify-center shadow-[0_0_20px_rgba(245,158,11,0.3)] font-black text-slate-950 text-base sm:text-lg">
            ⚡
          </div>
          <div>
            <span className="font-display font-black text-lg sm:text-2xl tracking-tight bg-gradient-to-r from-white via-slate-100 to-slate-400 bg-clip-text text-transparent">
              TECHLOOM
            </span>
            <span className="hidden md:inline-block ml-2 text-[10px] tracking-widest font-bold uppercase px-2 py-0.5 rounded-full bg-amber-400/10 text-amber-400 border border-amber-400/30">
              STORE
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-xs sm:max-w-md relative min-w-0">
          ...
          <input
            ...
            className="w-full bg-[#151B26] border border-white/10 pl-8 sm:pl-10 pr-7 sm:pr-4 py-1.5 sm:py-2 text-xs text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 rounded-full transition-all shadow-inner"
          />
          {search && (
            <button
              onClick={() => onSearch('')}
              className="absolute inset-y-0 right-0 pr-2.5 sm:pr-3.5 flex items-center text-xs text-slate-400 hover:text-white"
            >
              ✕
            </button>
          )}
        ...
        {/* Navigation & Actions */}
        <nav className="flex items-center gap-1.5 sm:gap-3 text-xs font-medium shrink-0">
          <button
            onClick={() => onNavigate('shop')}
            className={`hidden sm:inline-flex px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl transition-all ${
              view === 'shop'
          ...
          <button
            ...
            className={`px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-xl transition-all flex items-center gap-1 sm:gap-1.5 ${
              view === 'orders'
                ? 'bg-white/10 text-white font-bold'
                : 'text-slate-400 hover:text-white hover:bg-white/5'
            }`}
          ...
          <button
            ...
            className={`px-2.5 py-1.5 sm:px-3.5 sm:py-2 rounded-xl transition-all flex items-center gap-1.5 border ${
              view === 'admin'
          ...
          <button
            ...
            className={`relative px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-xl transition-all flex items-center gap-1.5 sm:gap-2 border ${
              view === 'cart'
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="inline-flex items-center justify-center min-w-[16px] h-4 sm:min-w-[18px] sm:h-4.5 px-1 text-[9px] sm:text-[10px] font-bold bg-amber-500 text-slate-950 rounded-full animate-bounce">
                {cartCount}
              </span>
            )}
          </button>
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-1.5 sm:gap-2.5 p-1 sm:pl-2 sm:pr-2.5 sm:py-1.5 rounded-full bg-[#151B26] hover:bg-[#1A2230] border border-white/10 hover:border-amber-400/50 transition-all cursor-pointer shadow-sm group"
              title="Profile & Settings"
            >
              <img
                src={userAvatar}
                alt="Profile"
                className="w-6 h-6 sm:w-7 sm:h-7 rounded-full object-cover border border-amber-400/40"
              />
              <span className="hidden lg:inline font-semibold text-white max-w-[90px] truncate text-xs">
                {userName.split(' ')[0]}
              </span>
              <svg
                className={`w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-400 group-hover:text-white transition-transform ${
                  menuOpen ? 'rotate-180' : ''
                }`}
                fill="none"
                stroke="currentColor"
